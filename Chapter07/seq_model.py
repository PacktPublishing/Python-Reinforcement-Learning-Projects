...
class Seq2Seq_chatbot():
    ...
    """ Seq2seq based dilaogue generator used for the reverse model for the backward entropy loss for determining the semantic coherence reward for the policy gradients dialogue"""
